  ...
  return (
    <nav className="bg-coffee-900 text-white shadow-lg sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-coffee-400 rounded-full flex items-center justify-center">
              <span className="text-coffee-900 font-bold text-lg">☕</span>
            </div>
            <span className="font-display font-bold text-xl">Café Demo</span>
          </Link>
          ...
          <div className="md:hidden">
            <button
              ...
              type="button"
              className="bg-coffee-800 inline-flex items-center justify-center p-2 rounded-md text-coffee-200 hover:text-white hover:bg-coffee-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
      ...
      <div className={`md:hidden ${isOpen ? 'block' : 'hidden'}`} id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-coffee-800">
          {navItems.map((item) => (
            <Link
              key={item.path}
              to={item.path}
